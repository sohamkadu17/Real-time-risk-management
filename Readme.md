...
This project is released for educational and demonstrative purposes as part of the Real-Time Risk Management System.

---

*Built with ❤️ using FastAPI · Pathway · PostgreSQL · React · TypeScript · Recharts*
